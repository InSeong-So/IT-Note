...
## 💬 `객체 지향형 프로그래밍`과 `5가지 원칙`을 설명해주세요.
...
## 💬 객체 지향 프로그래밍과 함수형 프로그래밍의 가장 큰 `차이점`은 무엇인가요?
...
## 💬 웹 사이트를 만들 때 `고려해야 할 사항`은 무엇이 있을까요?
- 사용자 인터페이스(UI)
- 보안(Security)
- 성능(Performance)
- 검색 엔진 최적화(SEO)
...
## 💬 `웹 페이지를 만들 때의 과정`을 설명해주실 수 있을까요?
...
## 💬 `점진적 향상법`과 `우아한 성능저하법`의 차이를 설명하실 수 있습니까?
...
## 💬 `FOUC`에 대해 설명해주세요. 또 FOUC를 피하기 위해선 어떻게 해야 하나요?
